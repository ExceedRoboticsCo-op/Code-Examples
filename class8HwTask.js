...
var startWelcomeState = true; // for welcome state
...
playState.create = function() {
  ...
  this.time.events.add(10000, this.overtime, this);
...
playState.overtime = function(){
  game.state.start("overtime");
};
...
// Overtime State Starts Here...

overtimeState.create = function () { 
    this.overtimeText = game.add.text(10,10, "Overtime !!!");
    this.overtimeText.fill = "#ffffff";
    this.time.events.add(3000, this.restart, this);
};

overtimeState.restart = function(){
...
victoryState.create = function () { 
    this.victoryText = game.add.text(10,10, "Victory Achieved !!!");
...
defeatState.create = function () { 
    this.defeatText = game.add.text(10,10, "Defeat Achieved !!!");
...
welcomeState.create = function () { 
    ...
    this.infoText = game.add.text(75,260, "Press Space to Start");
...
game.state.add("overtime", overtimeState);
game.state.start("play");