...
playState.create = function() {
  ...
  tween2 = game.add.tween(platform3);
  tween2.to({x:75, y: 150}, 1000, null, true, 0,-1,true);
  
  tween2 = game.add.tween(platform1);
  tween2.to({x:200, y: 220}, 500, null, true, 0,-1,true);
